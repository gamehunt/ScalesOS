...
void compose_cl_draw(compose_client_t* ctx, int op, uint32_t* data, int param_amount);
...
void compose_sv_draw(compose_server_t* srv, compose_client_t* ctx, int op, uint32_t* data);
